# Taken from https://github.com/ly9802/DynamicAccumulatedAttentionMap by ly9802
# -- coding:utf-8 --
# @Time:2024/6/2 8:52
# @Author Steven
...
class ActivationAndGradients:
    ...
    def prj_gradient(self,module,input,output):
        if not hasattr(input[0], "requires_grad") or not input[0].requires_grad:
            input = (input[0].clone().detach().requires_grad_(),)
            # print("hello, input doesn't have set reguires_grad to True - updating")
            # return
...
class DynamicAccumulatedAttentionMap:
    ...
    def forward(self,input_tensor,target_label=None) :
        ...
        return cam_list,predicted_label, target_label
